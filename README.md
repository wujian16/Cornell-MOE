...
The conda package is available at [https://anaconda.org/frazierlab]. Users can install the package by adding the frazierlab channel to their configurations/

### For Python 2 User

If you install cornell-moe to a particular virtual environment:
````bash
