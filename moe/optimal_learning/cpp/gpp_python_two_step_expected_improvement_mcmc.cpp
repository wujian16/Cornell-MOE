...
void ExportTwoStepExpectedImprovementMCMCFunctions() {
  boost::python::def("compute_two_step_expected_improvement_mcmc", ComputeTwoStepExpectedImprovementMCMCWrapper, R"%%(
  ...
  boost::python::def("compute_grad_two_step_expected_improvement_mcmc", ComputeGradTwoStepExpectedImprovementMCMCWrapper, R"%%(
  ...
  boost::python::def("multistart_two_step_expected_improvement_mcmc_optimization", MultistartTwoStepExpectedImprovementMCMCOptimizationWrapper, R"%%(
