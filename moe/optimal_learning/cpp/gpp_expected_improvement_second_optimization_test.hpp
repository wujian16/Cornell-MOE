...
#ifndef MOE_OPTIMAL_LEARNING_CPP_GPP_EXPECTED_IMPROVEMENT_SECOND_OPTIMIZATION_TEST_HPP_
#define MOE_OPTIMAL_LEARNING_CPP_GPP_EXPECTED_IMPROVEMENT_SECOND_OPTIMIZATION_TEST_HPP_
...
\endrst*/
OL_WARN_UNUSED_RESULT int Ping2EISecondGeneralTest();
...
/*!\rst
  ...
  \return
    number of test failures: 0 if all is working well.
\endrst*/
OL_WARN_UNUSED_RESULT int Run2EISecondTests();
...
#endif  // MOE_OPTIMAL_LEARNING_CPP_GPP_EXPECTED_IMPROVEMENT_SECOND_OPTIMIZATION_TEST_HPP_