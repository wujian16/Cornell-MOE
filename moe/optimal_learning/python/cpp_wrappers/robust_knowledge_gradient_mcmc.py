...
class RobustKnowledgeGradientMCMC(OptimizableInterface):
    ...
    def compute_robust_knowledge_gradient_mcmc(self, force_monte_carlo=False):
    ...
    def compute_grad_robust_knowledge_gradient_mcmc(self, force_monte_carlo=False):
