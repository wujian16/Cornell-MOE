...
def multistart_two_step_expected_improvement_mcmc_optimization(
        twoei_optimizer,
        inner_optimizer,
        num_multistarts,
        discrete_pts,
    ...
    return cpp_utils.uncppify(best_points_to_sample, (num_to_sample, twoei_optimizer.objective_function.dim))


class TwoStepExpectedImprovementMCMC(OptimizableInterface):
    ...
    def evaluate_at_point_list(
        ...
        return twoei_values_mcmc

    def compute_two_step_expected_improvement_mcmc(self, force_monte_carlo=False):
    ...
    compute_objective_function = compute_two_step_expected_improvement_mcmc

    def compute_grad_two_step_expected_improvement_mcmc(self, force_monte_carlo=False):
